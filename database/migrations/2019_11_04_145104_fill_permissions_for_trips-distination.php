...
class FillPermissionsForTripsDistination extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForTripsDistination constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.trips-distination',
            'admin.trips-distination.index',
            'admin.trips-distination.create',
            'admin.trips-distination.show',
            'admin.trips-distination.edit',
            'admin.trips-distination.delete',
        ]);
