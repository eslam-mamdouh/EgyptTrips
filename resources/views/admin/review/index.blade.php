                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'trip'">{{ trans('admin.review.columns.trip') }}</th>
                                    <th is='sortable' :column="'rate'">{{ trans('admin.review.columns.rate') }}</th>
                                    <th is='sortable' :column="'name'">{{ trans('admin.review.columns.name') }}</th>
                                    <th is='sortable' :column="'country'">{{ trans('admin.review.columns.country') }}</th>
                                    <th is='sortable' :column="'created_at'">{{ trans('Created at') }}</th>
                                ...
                                <tr v-for="(item, index) in collection" :key="item.id" :class="bulkItems[item.id] ? 'bg-bulk' : ''">
                                    ...
                                    <td>
                                        <div class="row no-gutters">
                                            <div class="col-auto">
                                                <a class="btn btn-sm btn-spinner btn-info" :href="item.resource_url + '/edit'" title="{{ trans('brackets/admin-ui::admin.btn.edit') }}" role="button"><i class="fa fa-eye"></i></a>
                                            </div>
