                        ...
                        <table class="table table-hover table-listing">
                            <thead>
                                <tr>
                                    ...
                                    <th is='sortable' :column="'name'">{{ trans('admin.booking.columns.name') }}</th>
                                    <th is='sortable' :column="'phone'">{{ trans('admin.booking.columns.phone') }}</th>
                                    <th is='sortable' :column="'date'">{{ trans('admin.booking.columns.date') }}</th>
                                    <th is='sortable' :column="'trip'">{{ trans('admin.booking.columns.trip') }}</th>
                                    <th is='sortable' :column="'total_price'">{{ trans('admin.booking.columns.total_price') }}</th>
